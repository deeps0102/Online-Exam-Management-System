...
class Database {
    ...
    public static void init()
    {
        ...
        try{
            ...
            stmt.executeUpdate("create table results(examName varchar(30) primary key, userName varchar(30), totmarks varchar(5), userstatus varchar(30), examDate datetime, foreign key(examDate) references exams(examDate), foreign key(userName) references users(userName), foreign key(examName) references exams(examName))");
